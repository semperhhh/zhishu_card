...
class ColorUtil {
  ...
  static const Color main_light_app = Color(0xFFF5F5F5);
  // 主颜色-dark
  static const Color main_dark_app = Color(0xFF000000);
  static const Color main_dark1_app = Color(0xFF181818);
  static const Color main_dark2_app = Color(0xFF333333);
